...
const (
	CHROOT_PATH = "/tmp/anhdle14/rootfs"
	CG_NAME     = "anhdle14"
	CG_ROOT     = "/sys/fs/cgroup"
	ALPINE_URI  = "http://dl-cdn.alpinelinux.org/alpine/v3.10/releases/x86_64/alpine-minirootfs-3.10.2-x86_64.tar.gz"
)
...
func runChild(args []string) {
	...
	cmd.Env = append(cmd.Env, "PATH=/bin:/usr/bin:/sbin")
	cmd.Stdin = os.Stdin
	cmd.Stdout = os.Stdout
	cmd.Stderr = os.Stderr
	if err := cmd.Run(); err != nil {
